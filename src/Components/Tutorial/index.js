    ...
    >
      <Modal.Body style={{fontFamily: 'Gotham Rounded'}}>
        ...
        <ul className={`ruleList ${classes.ruleList}`}>
          ...
          <li>
          <p className={classes.title}>  There are also other ways to accumulate coins. Judging is another way of acquiring coins from the app. End Users can judge 25 memes daily and gain 25 coins on a daily basis.</p>
            <div className={classes.box}>
            <div className="imgBox">
                <img src={img11} alt="" />
              </div>
