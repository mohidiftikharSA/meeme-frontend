...
const backgroundOverlayData = [{
    ...
    img: img14, coin: "100", title: "Galaxy",
}, {
    img: img15, coin: "100", title: "Cloudy Sky",
},];
const ProfileOverlayData = [{
    img: img16, coin: "100", title: "Purple",
}, {
    img: img17, coin: "100", title: "Pink",
}, {
    img: img18, coin: "100", title: "Orange",
},];
const ProfileOverlayDataProfile = [{
    img: img19, coin: "100", title: "Purple",
}, {
    img: img20, coin: "100", title: "Pink",
}, {
...
const data44 = [{
    ...
    title: "Military Theme", img: img3,
}, {
    title: "Camping Theme", img: img4,
}, {
    title: "Psychedelic Theme", img: img5,
}, {
    title: "Banana Theme", img: img6,
},];

const data2 = [{
    img: Theme1, title: "Camouflage theme",
}, {
    img: Theme2, title: "Sunflower theme",
}, {
    img: Theme3, title: "Green theme",
},];

const TabDetails = ({
    tournament, first, main, footer, tabTitle, storeitems, profile, customizeProfile, profilePosts,
    isPublic, postRemoved, otherProfile, tournamentPosts
}) => {
    ...
    return (<>
        ...
        {footer && (<Tabs defaultActiveKey={tabTitle} className="modalTabs">
            <Tab
                eventKey="terms"
        ...
        {profile && (<Tabs defaultActiveKey={"post"} className="mb-5 double">
            <Tab eventKey="post" title="Post">
                <ProfilePost myProfile otherProfile={otherProfile} data={profilePosts} postRemoved={postRemoved} />
            </Tab>
