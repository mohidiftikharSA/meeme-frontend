...
const Navigation = ({ header, footer }) => {
  ...
  const addActiveClass = (match, location) => {
    return match ? "active" : "";
  };
        ...
        <>
          ...
          <Navbar className={`responsive-nav ${isActive ? "active" : ""}`}>
            ...
            <Nav className="me-auto flex-lg-row flex-column ">
              <Nav.Link
                className={`nav-link ${addActiveClass("/home")}`}
                as={Link}
                to="/home"
              >
              ...
              className={`nav-link ${addActiveClass("/explore")}`}
              >

                <img className="nav-icon" src={expore} alt="icon"></img>Explore
              </Nav.Link>
              <Nav.Link as={Link} to="/tornament">
                <img src={trophy} alt="icon"></img>Tournament
              </Nav.Link>
              <Nav.Link as={Link} to="/BuyCoin">
